...
class BusinessNews extends StatefulWidget {
  @override
  _BusinessNewsState createState() => new _BusinessNewsState();
}

class _BusinessNewsState extends State<BusinessNews> with AutomaticKeepAliveClientMixin<BusinessNews> {
  ...
  FetchNews() async {
    var response = await http.get(
        'https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=7f01c190581f4f2cb139125272fc5ffc');
