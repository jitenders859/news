...
class SportsNews extends StatefulWidget {
  @override
  _SportsNewsState createState() => new _SportsNewsState();
}

class _SportsNewsState extends State<SportsNews> with AutomaticKeepAliveClientMixin<SportsNews> {
  ...
  FetchNews() async {
    var response = await http.get(
        'https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=7f01c190581f4f2cb139125272fc5ffc');
