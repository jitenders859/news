...
class EntertainmentNews extends StatefulWidget {
  @override
  _EntertainmentNewsState createState() => new _EntertainmentNewsState();
}

class _EntertainmentNewsState extends State<EntertainmentNews> with AutomaticKeepAliveClientMixin<EntertainmentNews> {
  ...
  FetchNews() async {
    var response = await http.get(
        'https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=7f01c190581f4f2cb139125272fc5ffc');
