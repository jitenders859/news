...
class HealthNews extends StatefulWidget {
  @override
  _HealthNewsState createState() => new _HealthNewsState();
}

class _HealthNewsState extends State<HealthNews> with AutomaticKeepAliveClientMixin<HealthNews> {
  ...
  FetchNews() async {
    var response = await http.get(
        'https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=7f01c190581f4f2cb139125272fc5ffc');
