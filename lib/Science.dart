...
class ScienceNews extends StatefulWidget {
  @override
  _ScienceNewsState createState() => new _ScienceNewsState();
}

class _ScienceNewsState extends State<ScienceNews> with AutomaticKeepAliveClientMixin<ScienceNews> {
  ...
  FetchNews() async {
    var response = await http.get(
        'https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=7f01c190581f4f2cb139125272fc5ffc');
