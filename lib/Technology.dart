...
class TechnologyNews extends StatefulWidget {
  @override
  _TechnologyNewsState createState() => new _TechnologyNewsState();
}

class _TechnologyNewsState extends State<TechnologyNews> with AutomaticKeepAliveClientMixin<TechnologyNews> {
  ...
  FetchNews() async {
    var response = await http.get(
        'https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=7f01c190581f4f2cb139125272fc5ffc');
